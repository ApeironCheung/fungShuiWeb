...
//1950-2025年數據來自中研院 https://sinocal.sinica.edu.tw/
...
const LUNAR_HEX = [
    ...
    0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2, // 1901
    0x04ae0, 0x0a5b6, 0x0a4d0, 0x0d250, 0x1d255, 
    0x0b540, 0x0d6a0, 0x0ada2, 0x095b0, 0x14977, // 1911
    0x04970, 0x0a4b0, 0x0b4b5, 0x06a50, 0x06d40, 
    0x1ab54, 0x02b60, 0x09570, 0x052f2, 0x04970, // 1921
    ...
    0x05260,0x0F263, 0x0D250, 0x05B57, 0x056A0, //1960-1969
    ...
    0x06B58, 0x05AC0, 0x0AB60, 0x096D5, 0x092E0, //1990-1999
    0x0B960, 0x0D954, 0x0D4A0, 0x0DA50, 0x07552, 
    0x056A0, 0x0BBB7, 0x025D0, 0x092D0, 0x0CAB5, //2000-2009
    ...
    0x02b60, 0x09570, 0x052e5, 0x04970, 0x06560, // 2041
    0x0d4a6, 0x0ea50, 0x06e90, 0x05ad6, 0x02b60, 
    0x086e0, 0x07ae5, 0x0c950, 0x0d4a0, 0x0d8a6, // 2051
    0x0b550, 0x056a0, 0x1a5b4, 0x025b0, 0x092b0, 
    0x0a925, 0x0a950, 0x0b4a0, 0x0b6a4, 0x0ad50, // 2061
    0x055a0, 0x0aba4, 0x0a5b0, 0x052b0, 0x0b273, 
    0x06930, 0x07330, 0x06aa5, 0x0ad50, 0x04b50, // 2071
    0x04b64, 0x0a570, 0x05270, 0x0d266, 0x0d930, 
    0x0d560, 0x146c5, 0x0df40, 0x0d8a0, 0x16554, // 2081
    0x056a0, 0x0aad0, 0x055d2, 0x04ae0, 0x0a5b6, 
    0x0a4d0, 0x0d250, 0x1d255, 0x0b540, 0x0d6a0  // 2091
];
...
const START_OFFSETS = [
    ...
    36, 25, 43, 33, 50, 40, 30, 49, 37, 26, // 1981-1990
    45, 34, 22, 40, 30, 18, 37, 27, 46, 35, // 1991-2000
    23, 42, 31, 21, 39, 28, 47, 36, 25, 44, // 2001-2010
    33, 22, 40, 30, 49, 38, 27, 46, 34, 24, // 2011-2020
    42, 31, 21, 40, 28, 47, 36, 25, 43, 33, // 2021-2030
    32, 21, 40, 30, 48, 26, 45, 34, 23, 42, // 2031-2040
...
function getLunarYearInfo2(year) {
    return lunarYearAnalyze(year, LUNAR_HEX, 1901, 2099);
}

function lunarYearAnalyze(year, info, start, end) {
