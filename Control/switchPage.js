...
// 選單的選項定義
let menu = [  ["流年運程", "仙家靈簽", "八字算命","紫微斗數","天罡秤骨","常用經咒","節氣誕期","九星氣學"],//預設語言
                ['controlYear','ORACLE','ASTROLOGY','POLAR_STAR','BONE_WEIGH','SUTRA','CALENDAR','JP_ASTRO']];//updateSubscribtion用key
...
export function attachMenuListeners() {
    attachListener('btn-menuSelect', switchFunt);
}