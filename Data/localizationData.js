...
import { SUTRA_LIST, SUTRA_BOOK_MAPPING,
    ...
    JUNTI_SUTRA, BOOK_OF_CHANGES,MARICI_SUTRA, HOI_GWONG_LING,YELLOW_EMPEROR_HIDDEN_TALISMAN
 } from './sutra.js';
...
const LOCAL_DATA = {
    ...
    CONFUCIUS_CLASSIC,
    GOON_YUM_GAO_FOO_GING, DAAI_BEI_JAU,
    ON_TAO_AND_VIRTUE, BOOK_OF_QUIET_AND_PURE, YELLOW_EMPEROR_HIDDEN_TALISMAN,
    HEART_SUTRA, FREE_WANDERING, DIAMOND_SUTRA,
    SEA_DRAGON_KING_CLASSIC, JING_TIN_DEI_SAN_JAU,
    GAM_GWONG_SAN_JAU, WAI_LING_SAN_JAU, CHING_SE_LING_JAU,
    JUNTI_SUTRA, BOOK_OF_CHANGES,MARICI_SUTRA, HOI_GWONG_LING,
    CALENDAR_I18N
}
